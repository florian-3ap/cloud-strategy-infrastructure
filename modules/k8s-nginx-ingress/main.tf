    ...
    controller:
      service:
        annotations:
          ...
          service.beta.kubernetes.io/aws-load-balancer-subnets: ${join(", ", var.subnets)}
          service.beta.kubernetes.io/aws-load-balancer-eip-allocations: ${join(",", var.eip_allocations)}
